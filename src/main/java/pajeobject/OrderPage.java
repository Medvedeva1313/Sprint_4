...
public class OrderPage {
    ...
    private By orderSecondPageFieldRentalPeriodSublist = By.className("Dropdown-menu"); ;
    ...
    private By orderForm = By.xpath(".//div[@class='Order_Header__BZXOb' and text()='Для кого самокат']");
    ...
    public boolean isOrderForm(){
        return driver.findElement(orderForm).isEnabled();
    }
